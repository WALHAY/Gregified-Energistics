package com.walhay.gregtechenergistics.common.metatileentities;

import static gregtech.common.metatileentities.MetaTileEntities.registerMetaTileEntity;

import com.walhay.gregtechenergistics.GregTechEnergisticsMod;
import com.walhay.gregtechenergistics.common.metatileentities.multiblockparts.MetaTileEntityMEALDataHatch;
import com.walhay.gregtechenergistics.common.metatileentities.multiblockparts.MetaTileEntityMEALHatch;
...
public class MetaTileEntities {
	...
	private static ResourceLocation location(String location) {
		return new ResourceLocation(GregTechEnergisticsMod.MOD_ID, location);
	}
